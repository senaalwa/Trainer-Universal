...
void OV7670_init(void)
{
	...
	write_reg(REG_COM10, 32);//PCLK does not toggle on HBLANK.
	setRes(VGA);
  	setColorSpace(RGB565);
	write_reg(0x11, 38); // ubah value sesuai resolusi QQVGA | QVGA > 20 |VGA > 40
  // write_reg(0x13, 0x8f); // Set ACE 
